...
public class OrderController implements OrderApi{
	...
	@Override
	@PostMapping("/v1/save")
	public ResponseEntity<String> saveOrder(HttpServletRequest request,@RequestBody OrdersDTO ordersDTO) {
	...
	public ResponseEntity<MemberDTO> getOrderByNumber(HttpServletRequest request,@PathVariable("orderNumber")String orderNumber) {
		String authorization = request.getHeader("Authorization");
	...
	public ResponseEntity<MemberDTO> getAllOrdersByUsername(HttpServletRequest request,@PathVariable("username")String username) {
		String authorization = request.getHeader("Authorization");
		return new ResponseEntity<>(orderService.getAllOrdersByUsername(username,authorization),HttpStatus.OK);
	}
	

	public ResponseEntity<MemberDTO> defaultOrders(HttpServletRequest request,String orderNumber) {
